...
function initDb(dataDir) {
  ...
  runMigration("ALTER TABLE book_files ADD COLUMN epub_url TEXT");

  // Migración Phase 3.5 — book_events
  db.exec(`CREATE TABLE IF NOT EXISTS book_events (
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS ai_usage_logs (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      user_id INTEGER,
      model_type TEXT, -- included, sonnet
      model_name TEXT,
      input_tokens INTEGER,
      output_tokens INTEGER,
      total_tokens INTEGER,
      provider_cost_usd REAL,
      user_charge_usd REAL,
      request_type TEXT,
      created_at TEXT,
      FOREIGN KEY (user_id) REFERENCES users(id)
    );
    ...
    CREATE TABLE IF NOT EXISTS billing_events (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      user_id INTEGER,
      type TEXT, -- sonnet_usage, manual_adjustment, subscription_renewal
      amount_usd REAL,
      description TEXT,
      metadata TEXT, -- JSON
      created_at TEXT,
